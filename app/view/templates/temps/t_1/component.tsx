...
const dTxt3 = "不褪色1k金莫桑石项链";

const T1:FC<any> = ({src,txt1,txt2,txt3} = {}) => {
    return <div className="wrap t-1">
        <div className="inner"> 
        <div className="circle"></div>
        <div className="txt1" dangerouslySetInnerHTML={{__html:txt1||dTxt1}}/>
        <div className="txt2" dangerouslySetInnerHTML={{__html:txt2||dTxt2}}/>
        <div className="txt3" dangerouslySetInnerHTML={{__html:txt3||dTxt3}}/>
        <img  src={src||dSrc}/>
        </div>
